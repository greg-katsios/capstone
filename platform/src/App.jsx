...
import { Shield, Brain, Flag, UserCircle, Send, Plus, MessageSquare, ThumbsUp, ThumbsDown, RotateCcw, Copy, Check, ChevronDown } from "lucide-react";
  ...
  return (
    <div style={{ marginTop: 28 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <button onClick={dec} style={{ width: a11y ? 42 : 36, height: a11y ? 42 : 36, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.15)", border: a11y ? "2px solid rgba(255,255,255,0.4)" : "none", color: "#fff", fontSize: 20, cursor: value <= 0 ? "not-allowed" : "pointer", opacity: value <= 0 ? 0.4 : 1, fontFamily: FONT, display: "flex", alignItems: "center", justifyContent: "center" }}>
          −
        </button>
        <div style={{ flex: 1, backgroundColor: "rgba(255,255,255,0.1)", borderRadius: 999, padding: "10px 0", textAlign: "center", color: "#fff", fontWeight: 700, fontSize: a11y ? 18 : 16, fontFamily: FONT, letterSpacing: "0.05em" }}>
          {value.toFixed(1)}
        </div>
        <button onClick={inc} style={{ width: a11y ? 42 : 36, height: a11y ? 42 : 36, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.15)", border: a11y ? "2px solid rgba(255,255,255,0.4)" : "none", color: "#fff", fontSize: 20, cursor: value >= 1 ? "not-allowed" : "pointer", opacity: value >= 1 ? 0.4 : 1, fontFamily: FONT, display: "flex", alignItems: "center", justifyContent: "center" }}>
          +
        </button>
      </div>
    </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", fontFamily: FONT, backgroundColor: "#fff", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden", minHeight: 0 }}>
        ...
        <aside style={{
          width: sidebarWidth,
          flexShrink: 0,
          backgroundColor: A11Y.sidebarBg,
          display: "flex",
            ...
            <div style={{ display: "flex", backgroundColor: "#fff", borderRadius: 999, padding: 4, marginBottom: 24, flexShrink: 0 }}>
              {["History", "Settings"].map(tab => (
                <button key={tab} onClick={() => setActiveTab(tab)}
                  style={{
                    flex: 1,
                    padding: accessibilityMode ? "12px 0" : "10px 0",
                    borderRadius: 999, border: "none",
                    fontWeight: 700,
                    fontSize: accessibilityMode ? 15 : 14,
                    cursor: "pointer", fontFamily: FONT,
                    backgroundColor: activeTab === tab ? A11Y.tabActiveBg : "transparent",
            ...
            {activeTab === "History" && (
              <div style={{ flex: 1, display: "flex", flexDirection: "column", paddingBottom: 20 }}>
                ...
                <button
                  ...
                  style={{
                    display: "flex", alignItems: "center", gap: 10,
                    padding: accessibilityMode ? "14px 16px" : "12px 16px",
                    borderRadius: 12,
                    backgroundColor: PURPLE,
                    border: accessibilityMode ? "2px solid rgba(255,255,255,0.3)" : "none",
                    color: "#fff", fontWeight: 700,
                    fontSize: accessibilityMode ? 15 : 13,
                    cursor: "pointer", marginBottom: 14, fontFamily: FONT,
                  }}>
                    ...
                    {conversations.map(c => {
                      ...
                      return (
                        <button key={c.id} onClick={() => setActiveChatId(c.id)}
                          style={{
                            padding: accessibilityMode ? "15px 16px" : "13px 16px",
                            borderRadius: 14,
                            backgroundColor: isActive ? PURPLE : A11Y.historyBg,
                            border: isActive
                              ? (accessibilityMode ? "2px solid #c4b5fd" : "2px solid #4ea3ff")
                              : A11Y.historyBorder,
                          ...
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8 }}>
                            <span style={{ fontSize: accessibilityMode ? 13 : 12, color: "rgba(255,255,255,0.75)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                              {c.role}
                            </span>
                            {c.createdAt && (
                              <span style={{ fontSize: accessibilityMode ? 12 : 11, color: "rgba(255,255,255,0.65)", whiteSpace: "nowrap", flexShrink: 0 }}>
                    ...
                    return (
                      <div key={role.name} style={{
                        ...
                        <button
                          onClick={() => {
                            setActiveRole(role);
                            setActivePersona(role.name);
                            setExpandedRole(isExpanded ? null : role.name);
                          }}
                          style={{
                            width: "100%", display: "flex", alignItems: "center", gap: 13,
                            padding: accessibilityMode ? "15px 14px" : "13px 14px",
                  ...
                  <div style={{
                    ...
                    <label style={{ position: "relative", width: 50, height: 28, flexShrink: 0, cursor: "pointer" }}>
                      ...
                      <span style={{
                        ...
                        backgroundColor: accessibilityMode ? "#7c3aed" : "rgba(255,255,255,0.25)",
